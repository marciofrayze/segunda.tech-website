...
var _mfdavid$indierank$Styles$headerRowStyle = _elm_lang$html$Html_Attributes$class('mdc-toolbar__row');
var _mfdavid$indierank$Styles$sectionStyle = _elm_lang$html$Html_Attributes$class('mdc-toolbar__section mdc-toolbar__section--align-start');
var _mfdavid$indierank$Styles$headerStyle = _elm_lang$html$Html_Attributes$class('mdc-toolbar mdc-toolbar--fixed mdc-toolbar--waterfall');
var _mfdavid$indierank$Styles$titleFont = {
	ctor: '::',
...
var _mfdavid$indierank$Styles$titleAttribute = _elm_lang$html$Html_Attributes$class('mdc-toolbar__title');
...
var _mfdavid$indierank$Router$ExercisesRoutes = function (a) {
	return {ctor: 'ExercisesRoutes', _0: a};
};
var _mfdavid$indierank$Router$OtherProjectsRoute = {ctor: 'OtherProjectsRoute'};
var _mfdavid$indierank$Router$AboutAuthorRoute = {ctor: 'AboutAuthorRoute'};
var _mfdavid$indierank$Router$BlogRoute = {ctor: 'BlogRoute'};
var _mfdavid$indierank$Router$MainPageRoute = {ctor: 'MainPageRoute'};
var _mfdavid$indierank$Router$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _mfdavid$indierank$Router$MainPageRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_mfdavid$indierank$Router$BlogRoute,
				_evancz$url_parser$UrlParser$s('blog')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_mfdavid$indierank$Router$AboutAuthorRoute,
					_evancz$url_parser$UrlParser$s('sobre')),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_mfdavid$indierank$Router$OtherProjectsRoute,
						_evancz$url_parser$UrlParser$s('projetos')),
					_1: {
						ctor: '::',
						_0: A2(
							_evancz$url_parser$UrlParser$map,
							_mfdavid$indierank$Router$ExercisesRoutes,
							A2(
								_evancz$url_parser$UrlParser_ops['</>'],
								_evancz$url_parser$UrlParser$s('exercicios'),
...
var _mfdavid$indierank$Main$headerDiv = A2(
	_elm_lang$html$Html$header,
	{
		ctor: '::',
		_0: _mfdavid$indierank$Styles$headerStyle,
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _mfdavid$indierank$Styles$headerRowStyle,
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _mfdavid$indierank$Styles$sectionStyle,
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _mfdavid$indierank$Styles$styles(_mfdavid$indierank$Styles$titleFont),
								_1: {
									ctor: '::',
									_0: _mfdavid$indierank$Styles$titleAttribute,
									_1: {ctor: '[]'}
								}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Segunda.tech'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _mfdavid$indierank$Main$mainPageDiv = _mfdavid$indierank$Main$headerDiv;
var _mfdavid$indierank$Main$view = function (model) {
	var _p0 = model.currentRoute;
	switch (_p0.ctor) {
		case 'MainPageRoute':
			return _mfdavid$indierank$Main$mainPageDiv;
		case 'BlogRoute':
			return _mfdavid$indierank$Main$mainPageDiv;
		case 'AboutAuthorRoute':
			return _mfdavid$indierank$Main$mainPageDiv;
		case 'OtherProjectsRoute':
			return _mfdavid$indierank$Main$mainPageDiv;
		case 'ExercisesRoutes':
			return _mfdavid$indierank$Main$mainPageDiv;
		default:
...
var _mfdavid$indierank$Main$stateBasedOnURL = F2(
	function (location, model) {
		var _p1 = _mfdavid$indierank$Router$parseLocation(location);
		switch (_p1.ctor) {
			case 'MainPageRoute':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{currentRoute: _mfdavid$indierank$Router$MainPageRoute}),
			...
			case 'BlogRoute':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{currentRoute: _mfdavid$indierank$Router$BlogRoute}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AboutAuthorRoute':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{currentRoute: _mfdavid$indierank$Router$AboutAuthorRoute}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'OtherProjectsRoute':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{currentRoute: _mfdavid$indierank$Router$OtherProjectsRoute}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ExercisesRoutes':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							currentRoute: _mfdavid$indierank$Router$ExercisesRoutes(_p1._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{currentRoute: _mfdavid$indierank$Router$NotFoundRoute}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _mfdavid$indierank$Main$update = F2(
	function (msg, model) {
		var _p2 = msg;
		return A2(_mfdavid$indierank$Main$stateBasedOnURL, _p2._0, model);
	});
...
var _mfdavid$indierank$Main$defaultModel = _mfdavid$indierank$Main$Model(_mfdavid$indierank$Router$NotFoundRoute);
